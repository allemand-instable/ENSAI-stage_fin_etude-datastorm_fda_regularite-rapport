...
L'hypothèse d'indépendance faible nous permet de tout de même utiliser l'estimateur usuel de l'espérance. Alors, les estimateurs des paramètres de régularité convergents ponctuellement vers ceux du processus dont sont issues nos données.
