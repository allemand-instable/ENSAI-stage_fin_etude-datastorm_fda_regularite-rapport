...
\info{Certaines ressources sur l'analyse de données fonctionnelles définissent les données fonctionnelles de la manière suivante :
	...
	Cependant, cette représentation ne permet pas une interprétation clé en main du concept mais certainement plus commode à manipuler pour les mathématiciens.
}