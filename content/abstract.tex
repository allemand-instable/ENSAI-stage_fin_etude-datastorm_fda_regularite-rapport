\begin{abstract}
	...
	Ceci est une version corrigée du rapport de stage ( car il m'était insupportable de voir des erreurs traîner ). Les passages corrigées sont annotés de \edited, par soucis d'intégrité et même parfois accompagnés d'une note de correction.
