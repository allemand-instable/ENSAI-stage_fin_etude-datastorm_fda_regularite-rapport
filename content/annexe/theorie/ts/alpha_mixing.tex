...
\warn{
    \smallskip\centering
    ERRATUM post-stage : une confusion a été faite dans le rapport rendu au jury, si aucune remarque n'a été apportée dessus lors de l'entretien il reste important de rectifier les erreurs d'interprétation qui peuvent surgir lors de la relecture des mois après la rédaction du rapport. Le texte concerné par la correction est affiché \textcolor{flatuicolors_rose}{\sout{de la façon suivante}} \textcolor{flatuicolors_blue_devil}{\textbf{avec le texte correctif associé}}.
}
