...
\begin{equation*}
	\mathcal T \, \isdef [\, 0,24 \,[ \quad \left(= \textsf{1 jour avec } t \textsf{ en heure}\right)
\end{equation*}
...
%
par exemple. Travailler sur des données fonctionnelles dans ce cadre c'est étudier non plus la consommation $y_i$ à midi, mais regarder l'ensemble de sa consommation en même temps sur toute la journée $\{ y_i = x_i(t) \textsf{ avec } t \in \mathcal T\}$.
