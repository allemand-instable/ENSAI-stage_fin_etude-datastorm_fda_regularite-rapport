...
\input{content/chapter_2/02-regularite_locale/regularite_locale.tex}

\pagebreak
\subsection{Modèle considéré}

\input{content/chapter_2/02-regularite_locale/modele.tex}

\subsection{Deux méthodes d'obtention de la régularité locale des trajectoires}
\label{sec:deux_methodes_estim}
\input{content/chapter_2/02-regularite_locale/regularite_locale_deux_methodes.tex}

\subsection{Prélissage}
\label{sec:regloc-prelissage}
\input{content/chapter_2/02-regularite_locale/prelissage.tex}

\subsection{Résumé de la méthodologie d'estimation de la régularité locale}

\input{content/chapter_2/02-regularite_locale/resume.tex}
