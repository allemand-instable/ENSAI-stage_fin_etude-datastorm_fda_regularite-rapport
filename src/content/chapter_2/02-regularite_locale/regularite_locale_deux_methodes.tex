...
\noindent et on obtient ainsi l'estimateur suivant :
...
\noindent Alors, on approche $\theta (t_1,t_3) = \esperance{ \left| X(t_3) - X(t_1) \right|^2 }$ par :
...
\noindent où $\hat X$ est la courbe lisssée à partir des observations :
